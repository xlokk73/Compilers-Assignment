...
enum classifier { digit, other, space, newline, dot, underscore, letter_char, mult_char, add_char, equals, greater_than, less_than, srb_char, erb_char, scb_char, ecb_char, comma_char, colon_char, s_colon_char, div_char, ssb_char, esb_char, eof_char };
...
const int total_accepting_states = 24;

/* Transition table */
const int transitions[][29] = {
       /*digit*/ /*other*/ /*space*/ /*newline*/ /*dot*/ /*underscore*/ /*letter_char*/ /*mult_char*/ /*add_char*/ /*equals*/ /*greater_than*/ /*less_than*/ /*srb_char*/ /*erb_char*/ /*scb_char*/ /*ecb_char*/ /*comma_char*/ /*colon_char*/ /*s_colon_char*/ /*div_char*/ /*ssb_char*/ /*esb_char*/ /*eof_char*/
